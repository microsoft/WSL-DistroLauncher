...
cd $TMPDIR
# 
sudo cdebootstrap -a $ARCH --include=sudo,locales,git,python3,apt-transport-https,wget,ca-certificates,gnome-themes-standard,gtk2-engines-murrine,dbus-x11,zsh $DIST $DIST http://deb.debian.org/debian
# clean apt cache
